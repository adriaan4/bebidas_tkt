...
function almacenPostgres() {
  ...
  const listo = (async () => {
    ...
    // Si la cadena de conexión está mal, el servidor sigue en pie y lo dice
    // en los logs en vez de morirse durante el arranque.
...
process.on("unhandledRejection", (e) => console.error("Fallo no atendido:", e && e.message));

app.listen(PORT, "0.0.0.0", () =>
  console.log("Traketeros en marcha en el puerto " + PORT)
);
